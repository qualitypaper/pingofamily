...
import { addToCurrentCursorPosition, isCorrect } from "../../../../utils/trainingUtils";
  ...
  return (
    <div className={`flex flex-col items-center`}>
      <TrainingBlock
        ...
        addChar={(c) => addToCurrentCursorPosition(simp.input, simp.setInput, c, textareaRef)}
